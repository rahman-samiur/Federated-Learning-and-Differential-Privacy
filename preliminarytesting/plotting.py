...
files = [
    ('evaluation_logsgd_nm1p0_cn0p1.jsonl','Noise Multiplier 1.0, Clipping Norm 0.1'),
    ('evaluation_logsgd_nm1p0_cn0p5.jsonl','Noise Multiplier 1.0, Clipping Norm 0.5'),
    ('evaluation_logsgd_nm1p0_cn1p0.jsonl','Noise Multiplier 1.0, Clipping Norm 1.0'),
    ('evaluation_logsgd_nm2p0_cn0p1.jsonl','Noise Multiplier 2.0, Clipping Norm 0.1'), 
    ('evaluation_logsgd_nm2p0_cn0p5.jsonl','Noise Multiplier 2.0, Clipping Norm 0.5'),
    ('evaluation_logsgd_nm2p0_cn1p0.jsonl','Noise Multiplier 2.0, Clipping Norm 1.0'),
    ('evaluation_logsgd_nm3p0_cn0p1.jsonl','Noise Multiplier 3.0, Clipping Norm 0.1'),
    ('evaluation_logsgd_nm3p0_cn0p5.jsonl','Noise Multiplier 3.0, Clipping Norm 0.5'), 
    ('evaluation_logsgd_nm3p0_cn1p0.jsonl','Noise Multiplier 3.0, Clipping Norm 1.0'),
